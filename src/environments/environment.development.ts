export const environment = {
    ...
    pathApi: '/api',
    dniEndpointPath: '/dni',
    livenessEndpointPath: '/liveness',
    demoCaptureEndpointPath: '/management/v1/facial-biometrics/capture',
    demoCompareEndpointPath: '/management/v1/facial-biometrics/compare',
    ...
    acjClientId: '7dG8kB4cU2eP9wX3',
    acjClientSecret: 'R5mK1oJ8vL3nQ9bA6tV2zS0yH4xE7qU5',
    acjChannel: 'API',
};
